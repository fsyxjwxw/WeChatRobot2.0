...
public interface RemindMapper extends BaseMapper<Remind> {
    ...
    @Select("select r.remind_id ,r.user_id,r.content,r.time,r.cron,r.type,u.name,r.to_name from r_remind r,r_user u where r.user_id = u.user_id and type = 1 ORDER BY time")
